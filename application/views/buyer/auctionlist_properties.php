      ...
      <div class="container mt-5 ">
        <div class="row border border-dark">
            ...
            <div class="switch-field justify-content-center py-3">
              <input type="radio" id="radio-three" name="switch-two" onchange="window.location.href = '<?php echo base_url();?>auctionlist_properties/index/TA';return false;" value="TA" <?php echo $chstata;?>/>
              <label for="radio-three">Today's Auctions</label>
              <input type="radio" id="radio-four" name="switch-two" onchange="window.location.href = '<?php echo base_url();?>auctionlist_properties/index/AA';return false;" value="ALL" <?php echo $chstaaa;?> />
