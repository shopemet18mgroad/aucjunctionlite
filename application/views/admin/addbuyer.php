                  ...
                  <div class="card-body">
                   ...
                   <div class= "row">
                      ...
                      <option value="West Bengal">West Bengal</option>
							...
							<div class="Col-sm-4">
							<button type="button" class="btn btn-info btn-rounded btn-lg mb-4">Submit</button>
						</div>
					<div class="Col-sm-4">
							<button type="button" class="btn btn-info btn-rounded btn-lg mb-4">Cancel</button>
							</div>
