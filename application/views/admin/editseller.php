...
<input type="text" class="form-control form-control-lg buyercontactnumber" id="icontactnumber" name="icontactnumber" maxLength="10"  value="<?php echo $sqldata[0]->icontactnumber ?>" readonly>
...
<input type="text" class="form-control form-control-lg" id="iaddres" name="iaddres" value="<?php echo $sqldata[0]->iaddres ?>" >
                    ...
                    <div class="col-md-12 mb-4 pb-2">
                      ...
                      <div class="form-outline form-white">
                      			  <select class="custom-select form-control form-control-lg form-control form-control-lg" id="istate" name="istate" style="border-radius:20px;" >
